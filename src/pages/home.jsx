        ...
        <main className="space-y-12">
          ...
          <section className="block">
            ...
            <div className="flex gap-4 sm:gap-6">
              <Button variant="secondary" className="flex-1 transition-all duration-300 py-4 sm:py-6 text-lg rounded-xl shadow-lg text-[16px] sm:text-[18px] hover:bg-[#f89b2adf] text-white font-normal sm:px-20">
                <ArrowDownLeft className="mr-2 h-5 sm:h-6 w-5 sm:w-6" /> Receive
              </Button>
              <Button variant="secondary" className="flex-1 text-white hover:bg-[#F89B2A]/90 transition-all duration-300 py-4 sm:py-6 text-lg rounded-xl shadow-lg sm:px-20">
